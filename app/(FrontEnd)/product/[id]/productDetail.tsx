	...
	return (
		<Layout>
			<Head>
				...
				<meta
					name="description"
					content={`Buy ${product.name} by ${product.brand}. Verified authentic.`}
				/>
				...
				<meta
					...
					content={`Buy ${product.name} by ${product.brand} for ${product.price} ${product.currency}.`}
				/>
				<meta name="twitter:image" content={product.images?.[0]} />
				<meta
					name="twitter:url"
					content={`${process.env.NEXT_PUBLIC_APP_URL}/product/${product._id}`}
				/>
